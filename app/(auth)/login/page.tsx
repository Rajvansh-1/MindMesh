    ...
    <div className="w-full max-w-md">
      <div className="glass rounded-3xl p-8 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 text-sm mt-1">Sign in to your MindMesh account</p>
        </div>

        {/* Google OAuth Button (only if configured) */}
        <button
          onClick={handleGoogle}
          className="w-full flex items-center justify-center gap-3 glass border border-white/20 hover:bg-white/10 text-white rounded-xl py-3 text-sm font-medium transition-all mb-6"
        >
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-white/30 text-xs">or email & password</span>
          <div className="flex-1 h-px bg-white/10" />
        </div>
